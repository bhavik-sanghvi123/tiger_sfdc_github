({
	executeRetrievalRecord : function(component, exported) {
        ...
        var self = this;
		var action = component.get('c.queryOrderReport');	
			...
			if (state == 'SUCCESS') {
                ...
                workspaceAPI.getFocusedTabInfo().then(function(response) {
                    ...
                    workspaceAPI.setTabLabel({
                        tabId: focusedTabId,
                        label: 'Order Export (Combined Line Items)'
                    });
	...
	executeDownloadExcel : function(component) {
        ...
        action.setCallback(this, function(action){
            ...
            if(state == 'SUCCESS') {
                ...
                download(strFile, "ExportOrder_" + result.userMarket + "_" + datestring + ".xls", "application/excel");
