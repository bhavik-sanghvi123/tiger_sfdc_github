({
	executeRetrievalRecord : function(component, exported) {
        ...
        var self = this;
		var action = component.get('c.queryOrderItemReport');	
	...
	executeDownloadExcel : function(component) {
        ...
        action.setCallback(this, function(action){
            ...
            if(state == 'SUCCESS') {
				...
				var fileName = "ExportOrder_" + result.userMarket + "_" + datestring + ".xls";
				if (result.userMarket == 'SG') {
					fileName = "ExtractedSampleRequestOrderReport_" + result.userMarket + "_" + datestring + ".csv";
					download(strFile, fileName, "application/text");
				} else {
					download(strFile, fileName, "application/excel");
				}
