({
        ...
        action.setCallback(this, function(action){          
            ...
            if(state == 'SUCCESS') {            
                ...
                if (result && result.length != 0) {
                    ...
                    else if(userMarket == "TW") {
                        component.find("Street1__c").set("v.value", result[0].Street1__c);
                        component.find("countryField").set("v.value", result[0].Country__c);
                        component.find("City2__c").set("v.value", result[0].City2__c);
                        component.find("addressDistrict").set("v.value", result[0].District__c);
                    }
                }
                else{
    ...
    retrievePreferredDeliveryTimePicklist : function(component) {
        var action = component.get("c.getPickListValuesPreferredDeliveryTime");
        action.setParams({            
        ...
        action.setCallback(this, function(action){          
            ...
            if(state == 'SUCCESS') {            
                ...
                console.log(items);
                component.set('v.preferredDeliveryTimePicklist', items);
    ...
    convertOrderlistToSalesforce : function(component, orderList) {
        ...
        if (orderList && orderList.length != 0) {            
            for(var i=0; i < orderList.length; i++) {
                ...
                order.UnitPrice = currentOrder.oUnitPrice + (currentOrder.oGSTValue/currentOrder.oQuantity);
    ...
    createParameter : function(component, createAddress) {
        ...
        var result = {
            ...
            vatValue : component.get("v.vatValue"), // Sean Cordova
            taxIDValue : component.get("v.taxIDValue"), // Sean Cordova
            taxNameValue : component.get("v.taxNameValue"), // Sean Cordova
            abbottPartnerCodeValue : component.get("v.abbottPartnerCodeValue"), // Sean Cordova
            promoterCodeValue : component.get("v.promoterCodeValue"), // Sean Cordova
            promoterNameValue : component.get("v.promoterNameValue"), // Sean Cordova
            abbottSalesPersonValue : component.get("v.abbottSalesPersonValue"), // Sean Cordova
            salesPersonCodeValue : component.get("v.salesPersonCodeValue"), // Sean Cordova
            salesPersonNameValue : component.get("v.salesPersonNameValue"), // Sean Cordova
            description : component.get("v.description") // Sean Cordova
        };
    ...
    checkRequireField : function(component) {
        ...
        if ((userMarket == "ID" || userMarket == "TW") && (component.find('addressDistrict').get("v.value") == null || component.find('addressDistrict').get("v.value") == '')) {
            isValid = false;
        }
        ...
        if(userMarket == 'TW' && (component.find('oPreferredDeliveryDate').get("v.value") == null)) {
            isValid = false;
        }
