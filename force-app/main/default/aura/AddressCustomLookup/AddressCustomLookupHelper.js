({
    searchRecordsHelper : function(component, event, helper, value) {
        ...
        action.setParams({
            ...
            'parentField' : component.get('v.parentName'),
            'parentValue' : component.get('v.parentValue'),
    ...
    searchTopRecordsHelper : function(component, event, helper, value) {
        $A.util.removeClass(component.find("Spinner"), "slds-hide");
        component.set('v.message','');
        component.set('v.recordsList',null);
		// Calling Apex Method
    	var action = component.get('c.fetchTopRecords');
        action.setStorable();
        action.setParams({
            'objectName' : component.get('v.objectName'),
            'filterField' : component.get('v.fieldName'),
