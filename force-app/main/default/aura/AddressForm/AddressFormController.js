({
	doInit : function(component, event, helper) {
		...
		if(sObjectName == "Contact") {
			...
			component.find("addressContact").set("v.value", recordId);
		}
        
        else if(sObjectName == "Account") {
			component.set("v.isCreate", true);
			component.set("v.householdId", recordId);
			component.set("v.addressId", "");
			component.find("addressHousehold").set("v.value", recordId);
		}

		else if(sObjectName == "Address__c") {
            if(recordId != null) {
    ...
    handleLoad : function(component, event) {
        ...
        if(userMarket != "ID" && userMarket != "TW") {
            component.set("v.isCustomRequired", false);
        }
    },
})