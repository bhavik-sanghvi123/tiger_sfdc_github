({
	executeRetrievalRecord : function(component, exported) {
        ...
        var self = this;
		var action = component.get('c.queryRewardItemReport');	
		...
		action.setCallback(this, function(response) {
			...
			if (state == 'SUCCESS') {
				...
				if (records.length > 0) {
					...
					component.set('v.rewardRecords', tempValue);
	...
	executeDownloadExcel : function(component) {
        ...
        action.setCallback(this, function(action){
            ...
            if(state == 'SUCCESS') {
                ...
                download(strFile, "ExportReward_" + result.userMarket + "_" + datestring + ".xls", "application/excel");
	...
	renderTable : function(component) {
		var records = component.get("v.rewardRecords"),
